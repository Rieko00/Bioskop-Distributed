            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @elseif(Auth::user()->role === 'kasir')
                        <!-- Kasir Menu Items -->
                        <x-nav-link :href="route('kasir.tickets')" :active="request()->routeIs('kasir.tickets')">
                            {{ __('Ticket Sales') }}
                        </x-nav-link>
                        <x-nav-link :href="route('kasir.schedules')" :active="request()->routeIs('kasir.schedules')">
                            {{ __('Film Schedules') }}
                        </x-nav-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @elseif(Auth::user()->role === 'kasir')
                ...
                <x-responsive-nav-link :href="route('kasir.tickets')" :active="request()->routeIs('kasir.tickets')">
                    {{ __('Ticket Sales') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('kasir.schedules')" :active="request()->routeIs('kasir.schedules')">
                    {{ __('Film Schedules') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('kasir.transactions')" :active="request()->routeIs('kasir.transactions')">
                    {{ __('Transactions') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('kasir.customers')" :active="request()->routeIs('kasir.customers')">
                    {{ __('Customers') }}
                </x-responsive-nav-link>
            @endif
        </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                ...
                <div class="font-medium text-xs text-blue-600">{{ ucfirst(Auth::user()->role) }}</div>
            </div>
